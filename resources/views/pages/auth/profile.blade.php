<x-web-layout title="Edit Profile">
                    ...
                    <div class="d-flex flex-wrap flex-sm-nowrap mb-3">
                        ...
                        <div class="me-7 mb-4">
                            <div class="symbol symbol-100px symbol-lg-160px symbol-fixed position-relative">
                                <img src="{{Auth::user()->foto == null ? asset('keenthemes/media/avatars/blank.png') : asset('storage/'.Auth::user()->foto)}}" alt="image" />
                            ...
                            <div class="d-flex justify-content-between align-items-start flex-wrap mb-2">
                                ...
                                <div class="d-flex flex-column">
                                    ...
                                    <div class="d-flex flex-wrap fw-bold fs-6 mb-4 pe-2">
                                        ...
                                        @elseif(Auth::user()->role == 'z')
                                        <!--end::Svg Icon-->Semua Hak Akses</a>
                                        @elseif(Auth::user()->role == 'sales')
                                        <!--end::Svg Icon-->Sales</a>
                                        @endif
                                        <a href="#" class="d-flex align-items-center text-gray-400 text-hover-primary me-5 mb-2">
                    ...
                    <form id="editProfileForm" class="form">
                        ...
                        <div class="card-body border-top p-9">
                            ...
                            <div class="row mb-6">
                                ...
                                <div class="col-lg-8">
                                    <!--begin::Image input-->
                                    <div class="image-input image-input-outline" data-kt-image-input="true" style="background-image: url({{asset('keenthemes/media/avatars/blank.png')}})">
                                        <!--begin::Preview existing avatar-->
                                        <div class="image-input-wrapper w-125px h-125px" style="background-image: url({{Auth::user()->foto == null ? asset('keenthemes/media/avatars/blank.png') : asset('storage/'.Auth::user()->foto)}})"></div>
                                ...
                                <div class="col-lg-8">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-12 fv-row">
                                            <input type="text" name="name" class="form-control form-control-lg form-control-solid" placeholder="Nama" value="{{Auth::user()->name}}" />
                                        </div>
                                        <!--end::Col-->
                                    </div>
                                    <!--end::Row-->
                            ...
                            <div class="row mb-6">
                                ...
                                <label class="col-lg-4 col-form-label fw-bold fs-6">
                                    ...
                                    <i class="fas fa-exclamation-circle ms-1 fs-7" data-bs-toggle="tooltip" title="Nomor HP harus ber format 08....."></i>
                                </label>
                                <!--end::Label-->
                                <!--begin::Col-->
                                <div class="col-lg-8 fv-row">
                                    <input type="tel" name="nomor_hp" class="form-control form-control-lg form-control-solid" placeholder="Nomor HP" value="{{Auth::user()->no_hp}}" />
                                </div>
                                <!--end::Col-->
                            </div>
                            <!--end::Input group-->
                            <!--begin::Input group-->
                             <div class="row mb-6">
                                <!--begin::Label-->
                                <label class="col-lg-4 col-form-label fw-bold fs-6">
                                    <span class="">Password Saat ini</span>
                                </label>
                                <!--end::Label-->
                                <!--begin::Col-->
                                <div class="col-lg-8">
                            ...
                            <div class="row mb-6">
                                <!--begin::Label-->
                                <label class="col-lg-4 col-form-label fw-bold fs-6">
                                    <span class="">Konfirmasi Password Baru</span>
                                </label>
                                <!--end::Label-->
                                <!--begin::Col-->
                                <div class="col-lg-8">
                        ...
                        <div class="card-footer d-flex justify-content-end py-6 px-9">
                            ...
                            <button onclick="handle_upload('#editProfileButton','#editProfileForm','{{route('profile.update')}}','PATCH','Simpan')" class="btn btn-primary" id="editProfileButton">Simpan Perubahan</button>
                        </div>
                        <!--end::Actions-->
                    </form>
                    <!--end::Form-->
