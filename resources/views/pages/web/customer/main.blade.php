        ...
        <div class="toolbar" id="kt_toolbar">
            ...
            <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                ...
                <div class="d-flex align-items-center py-1">
                            ...
                            <form id="content_filter">
                                <div class="px-7 py-5">
                                    ...
                                    <div class="mb-10">
                                        ...
                                        <!--begin::Input-->
                                        <div>
                                            <select name="owner" class="form-select form-select-solid" data-kt-select2="true" data-placeholder="Select option" data-allow-clear="true">
                    ...
                    <div class="me-4">
                        <a href="{{route('export.customer')}}" class="btn btn-sm btn-flex btn-success btn-active-primary fw-bolder">
                            <!--begin::Svg Icon | path: icons/duotone/Text/Filter.svg-->
                            <span class="svg-icon svg-icon-5 svg-icon-gray-500 me-1">
                    ...
                    <a href="javascript:;" onclick="load_input('{{route('customer.create')}}');" class="btn btn-sm btn-primary">
                        Create
                    </a>
                    <!--end::Button-->
                </div>
