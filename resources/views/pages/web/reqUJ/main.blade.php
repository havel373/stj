            ...
            <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                ...
                <div data-kt-place="true" data-kt-place-mode="prepend" data-kt-place-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center me-3">
                    ...
                    <h1 class="d-flex align-items-center text-dark fw-bolder my-1 fs-3">
                        ...
                        <!--end::Separator-->
                        <!--begin::Description-->
                        <small class="text-muted fs-7 fw-bold my-1 ms-1">Request Uang Jalan</small>
                        <!--end::Description-->
                    </h1>
                    <!--end::Title-->
                </div>
                ...
                <div class="d-flex align-items-center py-1">
                    ...
                    <div class="me-4">
                        <a href="{{route('export.reqUJ')}}" class="btn btn-sm btn-flex btn-success btn-active-primary fw-bolder">
                            <!--begin::Svg Icon | path: icons/duotone/Text/Filter.svg-->
                            <span class="svg-icon svg-icon-5 svg-icon-gray-500 me-1">
