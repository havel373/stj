    ...
    <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
        ...
        <div data-kt-place="true" data-kt-place-mode="prepend" data-kt-place-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center me-3">
            ...
            <h1 class="d-flex align-items-center text-dark fw-bolder my-1 fs-3">
                ...
                <!--end::Separator-->
                <!--begin::Description-->
                <small class="text-muted fs-7 fw-bold my-1 ms-1">No SPK : {{$history?->no_spk}} </small>
                <!--end::Description-->
            </h1>
            <!--end::Title-->
        </div>
...
<div class="card card-flush pt-3 mb-5 mb-xl-10">
    ...
    <div class="card-header card-header-stretch">
        ...
        <div class="card-title d-flex align-items-center">
            ...
            <!--end::Svg Icon-->
            <h3 class="fw-bolder m-0 text-gray-800">{{$history->tanggal}}</h3>
        </div>
        <!--end::Title-->
    </div>
    <!--end::Card head-->
                ...
                <div class="timeline">
                    ...
                    <div class="timeline-item">
                        ...
                        <div class="timeline-content mb-10 mt-n1">
                            ...
                            <div class="pe-3 mb-5">
                                <!--begin::Title-->
                                <div class="fs-5 fw-bold mb-2">Request Uang Jalan Senilai: Rp. {{number_format($history?->uangJalan?->uang_jalan)}}</div>
                                <!--end::Title-->
                                <!--begin::Description-->
                                <div class="d-flex align-items-center mt-1 fs-6">
                                    <!--begin::Info-->
                                    <div class="text-muted me-2 fs-7">Disetujui pada {{$history?->uangJalan?->updated_at}} oleh</div>
                                    <!--end::Info-->
                                    <!--begin::User-->
                                    <div class="symbol symbol-circle symbol-25px" data-bs-toggle="tooltip" data-bs-boundary="window" data-bs-placement="top" title="Bos">
                                        <img src="{{asset('keenthemes/media/avatars/150-11.jpg')}}" alt="img" />
                                    </div>
                                    <!--end::User-->
                                </div>
                                <!--end::Description-->
                            ...
                            {{-- <div class="overflow-auto pb-5">
                                ...
                                <div class="d-flex align-items-center border border-dashed border-gray-300 rounded min-w-750px px-7 py-3 mb-5">
                                    ...
                                    <div class="symbol-group symbol-hover flex-nowrap flex-grow-1 min-w-100px pe-2">
                                        ...
                                        <div class="symbol symbol-circle symbol-25px">
                                            <img src="{{asset('keenthemes/media/avatars/150-3.jpg')}}" alt="img" />
                                        </div>
                                        <!--end::User-->
                                        <!--begin::User-->
                                        <div class="symbol symbol-circle symbol-25px">
                                ...
                                <div class="d-flex align-items-center border border-dashed border-gray-300 rounded min-w-750px px-7 py-3 mb-0">
                                    ...
                                    <div class="symbol-group symbol-hover flex-nowrap flex-grow-1 min-w-100px">
                                        <!--begin::User-->
                                        <div class="symbol symbol-circle symbol-25px">
                                            <img src="{{asset('keenthemes/media/avatars/150-5.jpg')}}" alt="img" />
                                        </div>
                                        <!--end::User-->
                                        <!--begin::User-->
                                        <div class="symbol symbol-circle symbol-25px">
                            ...
                            <div class="overflow-auto pe-3">
                                ...
                                <div class="d-flex align-items-center mt-1 fs-6">
                                    ...
                                    <div class="symbol symbol-circle symbol-25px" data-bs-toggle="tooltip" data-bs-boundary="window" data-bs-placement="top" title="Alan Nilson">
                                        <img src="{{asset('keenthemes/media/avatars/150-2.jpg')}}" alt="img" />
                                    </div>
                                    <!--end::User-->
                                </div>
                                <!--end::Description-->
                            ...
                            <div class="mb-5 pe-3">
                                ...
                                <div class="d-flex align-items-center mt-1 fs-6">
                                    ...
                                    <div class="symbol symbol-circle symbol-25px" data-bs-toggle="tooltip" data-bs-boundary="window" data-bs-placement="top" title="Jan Hummer">
                                        <img src="{{asset('keenthemes/media/avatars/150-6.jpg')}}" alt="img" />
                                    </div>
                                    <!--end::User-->
                                </div>
                                <!--end::Description-->
                            ...
                            <div class="overflow-auto pb-5">
                                <div class="d-flex align-items-center border border-dashed border-gray-300 rounded min-w-700px p-5">
                                    ...
                                    <div class="d-flex flex-aligns-center pe-10 pe-lg-20">
                                        <!--begin::Icon-->
                                        <img alt="" class="w-30px me-3" src="{{asset('keenthemes/media/svg/files/pdf.svg')}}" />
                                        <!--end::Icon-->
                                        <!--begin::Info-->
                                    ...
                                    <div class="d-flex flex-aligns-center pe-10 pe-lg-20">
                                        <!--begin::Icon-->
                                        <img alt="" class="w-30px me-3" src="{{asset('keenthemes/media/svg/files/doc.svg')}}" />
                                        <!--end::Icon-->
                                        <!--begin::Info-->
                                        <div class="ms-1 fw-bold">
                                            <!--begin::Desc-->
                                    ...
                                    <div class="d-flex flex-aligns-center">
                                        <!--begin::Icon-->
                                        <img alt="" class="w-30px me-3" src="{{asset('keenthemes/media/svg/files/css.svg')}}" />
                                        <!--end::Icon-->
                                        <!--begin::Info-->
                                        <div class="ms-1 fw-bold">
                                            <!--begin::Desc-->
                    ...
                    <!--end::Timeline item-->
                    <!--begin::Timeline item-->
                    @foreach ($monitoring->details as $item)
                    <div class="timeline-item">
                        <!--begin::Timeline line-->
                        <div class="timeline-line w-40px"></div>
                        <!--end::Timeline line-->
                        ...
                        <!--begin::Timeline content-->
                            <div class="timeline-content mb-10 mt-n1">
                                ...
                                <div class="pe-3 mb-5">
                                    <!--begin::Title-->
                                    <div class="fs-5 fw-bold mb-2">{{ucfirst($item?->masterStatus?->nama_status)}}:</div>
                                    <!--end::Title-->
                                    <div class="d-flex align-items-center mt-1 fs-6">
                                        <!--begin::Info-->
                                        <div class="text-muted me-2 fs-7">{{$item?->status}} pada {{$item?->updated_at}} by</div>
                                        <!--end::Info-->
                                        <!--begin::User-->
                                    ...
                                    <div class="d-flex align-items-center border border-dashed border-gray-300 rounded min-w-700px p-7">
                                        ...
                                        <div class="overlay me-10">
                                            ...
                                            <div class="overlay-wrapper">
                                                <img alt="img" class="rounded w-200px" src="{{$attach->image}}" />
                                            </div>
                                            <!--end::Image-->
                                            <!--begin::Link-->
                    ...
                    <div class="timeline-item">
                        ...
                        <div class="timeline-content mb-10 mt-n1">
                            ...
                            <div class="pe-3 mb-5">
                                <!--begin::Title-->
                                <div class="fs-5 fw-bold mb-2">Laporan Perjalanan dibuat pada :</div>
                                <!--end::Title-->
                                <!--begin::Description-->
                                <div class="d-flex align-items-center mt-1 fs-6">
                                    <!--begin::Info-->
                                    {{-- <div class="text-muted me-2 fs-7">{{$history}} by</div> --}}
                                    <!--end::Info-->
                                    <!--begin::User-->
                                    <div class="symbol symbol-circle symbol-25px" data-bs-toggle="tooltip" data-bs-boundary="window" data-bs-placement="top" title="Robert Rich">
                                        <img src="{{asset('keenthemes/media/avatars/150-14.jpg')}}" alt="img" />
                                    </div>
                                    <!--end::User-->
                                </div>
                                <!--end::Description-->
                            ...
                            <div class="overflow-auto pb-5">
                                <div class="d-flex align-items-center border border-dashed border-gray-300 rounded min-w-700px p-7">
                                    ...
                                    <div class="overlay me-10">
                                        <!--begin::Image-->
                                        <div class="overlay-wrapper">
                                            <img alt="img" class="rounded w-200px" src="{{asset('keenthemes/media/demos/demo1.png')}}" />
                                        </div>
                                        <!--end::Image-->
                                        <!--begin::Link-->
                                        <div class="overlay-layer bg-dark bg-opacity-10 rounded">
                                    ...
                                    <div class="overlay me-10">
                                        <!--begin::Image-->
                                        <div class="overlay-wrapper">
                                            <img alt="img" class="rounded w-200px" src="{{asset('keenthemes/media/demos/demo2.png')}}" />
                                        </div>
                                        <!--end::Image-->
                                        <!--begin::Link-->
                                        <div class="overlay-layer bg-dark bg-opacity-10 rounded">
                                    ...
                                    <div class="overlay">
                                        <!--begin::Image-->
                                        <div class="overlay-wrapper">
                                            <img alt="img" class="rounded w-200px" src="{{asset('keenthemes/media/demos/demo3.png')}}" />
                                        </div>
                                        <!--end::Image-->
                                        <!--begin::Link-->
                                        <div class="overlay-layer bg-dark bg-opacity-10 rounded">
