<div id="kt_header" style="" class="header align-items-stretch">
    ...
    <div class="container-fluid d-flex align-items-stretch justify-content-between">
        ...
        <div class="d-flex align-items-center flex-grow-1 flex-lg-grow-0">
            <a href="?page=index" class="d-lg-none">
                <img alt="Logo" src="<?php echo e(asset('img/logo_admin.jpg')); ?>" class="h-30px" />
            </a>
        </div>
        <!--end::Mobile logo-->
        <!--begin::Wrapper-->
                ...
                <div class="d-flex align-items-stretch flex-shrink-0">
                    ...
                    <div class="d-flex align-items-center ms-1 ms-lg-3">
                        ...
                        <div class="menu menu-sub menu-sub-dropdown menu-column w-250px w-lg-325px" data-kt-menu="true">
                            <!--begin::Heading-->
                            <div class="d-flex flex-column flex-center bgi-no-repeat rounded-top px-9 py-10" style="background-image:url('<?php echo e(asset('keenthemes/media//misc/pattern-1.jpg')); ?>')">
                                <!--begin::Title-->
                    ...
                    <div class="d-flex align-items-center ms-1 ms-lg-3">
                        ...
                        <div class="menu menu-sub menu-sub-dropdown menu-column w-350px w-lg-375px" data-kt-menu="true">
                            <!--begin::Heading-->
                            <div class="d-flex flex-column bgi-no-repeat rounded-top" style="background-image:url('<?php echo e(asset('keenthemes/media//misc/pattern-1.jpg')); ?>')">
                                <!--begin::Title-->
                                ...
                                <div class="tab-pane fade show active" id="kt_topbar_notifications_2" role="tabpanel">
                                    ...
                                    <div class="d-flex flex-column px-9">
                                        ...
                                        <div class="text-center px-4">
                                            <img class="mw-100 mh-200px" alt="metronic" src="<?php echo e(asset('keenthemes/media/illustrations/work.png')); ?>" />
                                        </div>
                                        <!--end::Illustration-->
                                    </div>
                                    <!--end::Wrapper-->
                    ...
                    <div class="d-flex align-items-center ms-1 ms-lg-3" id="kt_header_user_menu_toggle">
                        ...
                        <div class="cursor-pointer symbol symbol-30px symbol-md-40px" data-kt-menu-trigger="click" data-kt-menu-attach="parent" data-kt-menu-placement="bottom-end" data-kt-menu-flip="bottom">
                            <img src="<?php echo e(Auth::user()->foto == null ? asset('keenthemes/media/avatars/blank.png') : asset('storage/'.Auth::user()->foto)); ?>" alt="metronic" />
                        </div>
                        <!--begin::Menu-->
                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold py-4 fs-6 w-275px" data-kt-menu="true">
                            ...
                            <div class="menu-item px-3">
                                <div class="menu-content d-flex align-items-center px-3">
                                    ...
                                    <div class="symbol symbol-50px me-5">
                                        <img alt="Logo" src="<?php echo e(Auth::user()->foto == null ? asset('keenthemes/media/avatars/blank.png') : asset('storage/'.Auth::user()->foto)); ?>" />
                                    </div>
                                    <!--end::Avatar-->
                                    <!--begin::Username-->
                                    <div class="d-flex flex-column">
                                        <div class="fw-bolder d-flex align-items-center fs-5">
                                            <?php echo e(Auth::user() ? Auth::user()->name : 'Nama'); ?>

                                            
                                        </div>
                                        <a href="#" class="fw-bold text-muted text-hover-primary fs-7">
                                            <?php echo e(Auth::user() ? Auth::user()->username : '08 '); ?>
                            ...
                            <div class="menu-item px-5">
                                <a href="<?php echo e(route('profile.edit')); ?>" class="menu-link px-5">Edit Profil</a>
                            </div>
    ...
    <!--end::Container-->
</div><?php /**PATH C:\laragon\www\stj.sweatboxfnp.com\resources\views/theme/web/header.blade.php ENDPATH**/ ?>