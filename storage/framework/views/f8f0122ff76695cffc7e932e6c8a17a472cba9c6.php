...
<?php $component = App\View\Components\WebLayout::resolve(['title' => 'Unit'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $component->withAttributes([]); ?>
        ...
        <div class="toolbar" id="kt_toolbar">
            ...
            <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                ...
                <div class="d-flex align-items-center py-1">
                    ...
                    <!--end::Wrapper-->
                    <?php if(Auth::User()->role == 'z' || Auth::user()->role == 'b' || Auth::user()->role == 'a'): ?>
                    <div class="me-4">
                        <a href="<?php echo e(route('export.monitoring')); ?>" class="btn btn-sm btn-flex btn-success btn-active-primary fw-bolder">
                            <!--begin::Svg Icon | path: icons/duotone/Text/Filter.svg-->
                            <span class="svg-icon svg-icon-5 svg-icon-gray-500 me-1">
                    ...
                    <!--begin::Button-->
                    <a href="javascript:;" onclick="load_input('<?php echo e(route('monitoring.create')); ?>');" class="btn btn-sm btn-primary">
                        Create
                    </a>
                    <!--end::Button-->
                </div>
    ...
    <?php $__env->startSection('custom_js'); ?>
        <script type="text/javascript">
            ...
            function reject(url){
                let rejectMessage = "";
                while (rejectMessage.trim() === '') {
                    rejectMessage = prompt("Masukan alasan menolak : ");
...
<?php endif; ?><?php /**PATH C:\laragon\www\stj.sweatboxfnp.com\resources\views/pages/web/monitoring/main.blade.php ENDPATH**/ ?>